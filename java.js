// let additem_btn = document.getElementById("add");
...
// //this is my container for items and to count
// let removedDisplay = document.createElement("div");
// removeBtn.after(removedDisplay);// i used .after because it was taught in class today

// let removedCounter = document.createElement("div");
// removeBtn.after(removedCounter);
...
// // so here because you only want white and yellow i used a if statement, which is the easiest way out using modulus.
//         if (i % 2 === 0) {
...
// // this is my code for the add buttion
...
// // i used append child because li is inside ul so that is why i did not just use append but rather appendchild
//         list.appendChild(li);
//     }
